...
export default function Detail() {
    ...
    const AddToFavorit = () => {
        return (
            <div className='mt-2'>
                <button type="button" className="btn btn-outline-success" onClick={handleAddFavorite}>
                    Add&nbsp;&nbsp;
    ...
    const ShowFavorite = () => {
        return (
            <div className='mt-2'>
                <button type="button" className="btn btn-outline-danger" onClick={handleRemoveFavorite}>
                    Remove&nbsp;&nbsp;
